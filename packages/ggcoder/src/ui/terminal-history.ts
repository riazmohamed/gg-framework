...
// Row index in the logo block where the info column starts. The OG mark is
// exactly three rows tall and there are three info lines, so it must be 0 —
// any offset pushes the last line (the shortcut hints) off the bottom.
