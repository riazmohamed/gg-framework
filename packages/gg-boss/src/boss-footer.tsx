...
interface BossFooterProps {
  ...
  /** Auto-updater has installed a newer @abukhaled/gg-boss in the background. */
...
const SHORT_RADIO: Record<string, string> = {
  ...
  "somafm-dark-zone": "Dark Zone",
  "somafm-drone-zone-2": "Drone Zone 2",
  "somafm-deep-space-one": "Deep Space One",
  "somafm-doomed": "Doomed",
  "somafm-synphaera": "Synphaera",
  bluemars: "Bluemars",
  "bluemars-cryosleep": "Cryosleep",
  "bluemars-voices": "Voices Within",
  "ambient-sleeping-pill": "Sleeping Pill",
  "radcap-dark-ambient": "Dark Ambient",
  "nightride-chillsynth": "Chillsynth",
  "nightride-datawave": "Datawave",
  "nightride-darksynth": "Darksynth",
  "nightwave-plaza": "Plaza",
