...
| [`@abukhaled/ggcoder`](https://www.npmjs.com/package/@abukhaled/ggcoder) | CLI coding agent with OAuth, tools, and TUI | [packages/ggcoder](packages/ggcoder/README.md) |

```
@abukhaled/gg-ai (standalone)
  └─► @abukhaled/gg-agent (depends on gg-ai)
        └─► @abukhaled/ggcoder (depends on both)
```
...
| Use a ready-made CLI coding agent | [`@abukhaled/ggcoder`](packages/ggcoder/README.md) |
...
npm i -g @abukhaled/ggcoder     # The full CLI
```
...
<p align="center">
  <a href="https://www.npmjs.com/package/@abukhaled/ggcoder"><img src="https://img.shields.io/badge/Install-npm%20i%20--g%20%40kenkaiiii%2Fggcoder-blue?style=for-the-badge" alt="Install"></a>
</p>
